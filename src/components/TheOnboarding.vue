  ...
  <div id="onboarding" v-if="showOnboarding">
    <div>
      ...
      <div class="licences">
        ...
        <section>
          <h4>Source code</h4>
          <blockquote><a href="https://github.com/siphore/a-frame-vite-vue-boilerplate">Github repo</a></blockquote>
        </section>
        <dl>
          <dt>
            <i>Included</i>
          ...
          <dt>
            <a href="https://skfb.ly/ou7PF" target="_blank">Wooden platform</a>
          </dt>
          <dd>
            by <a href="https://sketchfab.com/RyanBlack" target="_blank">RyanBlack</a>
            under <a href="https://creativecommons.org/licenses/by/4.0/" target="_blank">CC BY 4.0</a>
          </dd>

          <dt>
            <a href="https://skfb.ly/oIINu" target="_blank">SkyBox Anime Sky</a>
          </dt>
          <dd>
            by <a href="https://sketchfab.com/paul_paul_paul" target="_blank">Paul</a>
            under <a href="https://creativecommons.org/licenses/by/4.0/" target="_blank">CC BY 4.0</a>
          </dd>
        </dl>
      </div>
