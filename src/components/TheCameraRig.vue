...
import '../aframe/simple-physics.js';
</script>
...
<template>
  ...
  >
    ...
    <a-entity id="hand-left" hand-controls="hand: left" laser-controls="hand: left"
      raycaster="far: 15; objects: [clickable]; showLine: true;" position="0 1.5 0" grappling-hook>
